...
.ts-spin {
  animation: ts-spin 0.5s 0s infinite linear;
}
    ...
    computed: {
      ...
      klass () {
        return {
          'ts-icon': true,
          'ts-spin': this.spin,
          'ts-flip-horizontal': this.flip === 'horizontal',
          'ts-flip-vertical': this.flip === 'vertical',
          'ts-inverse': this.inverse,
          'ts-pulse': this.pulse,
